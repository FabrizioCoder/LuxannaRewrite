...
export default function createClient<Paths extends {}>(clientOptions?: ClientOptions): {
  ...
  GET<P extends PathsWithMethod<Paths, "get">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "get">>> extends never
      ? [(FetchOptions<FilterKeys<Paths[P], "get">> | undefined)?]
      : [FetchOptions<FilterKeys<Paths[P], "get">>]
  ): Promise<
    FetchResponse<
      "get" extends infer T ? (T extends "get" ? (T extends keyof Paths[P] ? Paths[P][T] : unknown) : never) : never
    >
  >;
  /** Call a PUT endpoint */
  PUT<P extends PathsWithMethod<Paths, "put">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "put">>> extends never
      ? [(FetchOptions<FilterKeys<Paths[P], "put">> | undefined)?]
      : [FetchOptions<FilterKeys<Paths[P], "put">>]
  ): Promise<
    FetchResponse<
      "put" extends infer T ? (T extends "put" ? (T extends keyof Paths[P] ? Paths[P][T] : unknown) : never) : never
    >
  >;
  /** Call a POST endpoint */
  POST<P extends PathsWithMethod<Paths, "post">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "post">>> extends never
      ? [(FetchOptions<FilterKeys<Paths[P], "post">> | undefined)?]
      : [FetchOptions<FilterKeys<Paths[P], "post">>]
  ): Promise<
    FetchResponse<
      "post" extends infer T ? (T extends "post" ? (T extends keyof Paths[P] ? Paths[P][T] : unknown) : never) : never
    >
  >;
  /** Call a DELETE endpoint */
  DELETE<P extends PathsWithMethod<Paths, "delete">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "delete">>> extends never
  ...
  OPTIONS<P extends PathsWithMethod<Paths, "options">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "options">>> extends never
  ...
  HEAD<P extends PathsWithMethod<Paths, "head">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "head">>> extends never
      ? [(FetchOptions<FilterKeys<Paths[P], "head">> | undefined)?]
      : [FetchOptions<FilterKeys<Paths[P], "head">>]
  ): Promise<
    FetchResponse<
      "head" extends infer T ? (T extends "head" ? (T extends keyof Paths[P] ? Paths[P][T] : unknown) : never) : never
    >
  >;
  /** Call a PATCH endpoint */
  PATCH<P extends PathsWithMethod<Paths, "patch">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "patch">>> extends never
      ? [(FetchOptions<FilterKeys<Paths[P], "patch">> | undefined)?]
      : [FetchOptions<FilterKeys<Paths[P], "patch">>]
  ): Promise<
    FetchResponse<
      "patch" extends infer T ? (T extends "patch" ? (T extends keyof Paths[P] ? Paths[P][T] : unknown) : never) : never
    >
  >;
  /** Call a TRACE endpoint */
  TRACE<P extends PathsWithMethod<Paths, "trace">>(
    url: P,
    ...init: HasRequiredKeys<FetchOptions<FilterKeys<Paths[P], "trace">>> extends never
      ? [(FetchOptions<FilterKeys<Paths[P], "trace">> | undefined)?]
      : [FetchOptions<FilterKeys<Paths[P], "trace">>]
  ): Promise<
    FetchResponse<
      "trace" extends infer T ? (T extends "trace" ? (T extends keyof Paths[P] ? Paths[P][T] : unknown) : never) : never
    >
  >;
};
...
export declare function defaultQueryParamSerializer<T = unknown>(key: string[], value: T): string | undefined;
