...
export default function createClient(clientOptions) {
   ...
   * @param {T} url
   * @param {import('./fetch.js').FetchOptions<T>} fetchOptions
   */
  async function coreFetch(url, fetchOptions) {
    ...
    const finalURL = createFinalURL(url, {
      baseUrl: fetchOptions.overwriteURL ?? baseUrl,
      params,
      querySerializer,
    });
 ...
 * @type {import("./fetch.js").defaultQuerySerializer}
 */
 ...
 * @type {import("./fetch.js").defaultQueryParamSerializer}
 */
 ...
 * @type {import("./fetch.js").deepObjectPath}
 */
 ...
 * @type {import("./fetch.js").defaultBodySerializer}
 */
 ...
 * @type {import("./fetch.js").createFinalURL}
 */
 ...
 * @type {import("./fetch.js").mergeHeaders}
 */
